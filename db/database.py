...
class Database:
    ...
    def _migrate(self, conn):
        ...
        migrations = {
            ...
            "accident_car": ["created_at", "car_id", "damage_cause", "auction_start_time", "auction_end_time", "is_new_energy"],
            "used_car": ["created_at", "car_id", "damage_cause", "auction_start_time", "auction_end_time", "is_new_energy"],
        }
